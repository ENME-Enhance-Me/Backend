...
export class createPeopleGroup1637221507127 implements MigrationInterface {
    name = 'createPeopleGroup1637221507127'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "peopleGroup" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, CONSTRAINT "PK_7ddd6a09ce87752a60f5a0d9609" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "research_people_groups_people_group" ("researchId" uuid NOT NULL, "peopleGroupId" integer NOT NULL, CONSTRAINT "PK_0bba07cc3b3ac0c60bcb248d14a" PRIMARY KEY ("researchId", "peopleGroupId"))`);
        ...
        await queryRunner.query(`ALTER TABLE "user" ADD "peopleGroupId" integer`);
